...
#define SR_SUPORT_PLAY_BACK			0x04000000							//支持回放
...
public:
	...
	//支持回放
	static bool IsSuportPlayBack(DWORD dwServerRule) { return (dwServerRule&SR_SUPORT_PLAY_BACK)!=0; }	
	//支持手机
	...
	//支持回放
	static VOID SetSuportPlayBack(DWORD& dwServerRule, bool bEnable) {  (bEnable==true)?dwServerRule|=SR_SUPORT_PLAY_BACK:dwServerRule&=~SR_SUPORT_PLAY_BACK; }
