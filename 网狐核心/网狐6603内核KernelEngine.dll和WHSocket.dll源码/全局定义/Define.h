...
#define LEN_VERIFICATION_CODE		16									//手机验证码
#define LEN_PROVINCE				10									//省份长度

#define LEN_ALIPAY_ACCOUNTS			32									//支付宝帐号
...
#define TASK_TYPE_CREATE_ROOM		0x100								//创建房间
#define TASK_TYPE_CONSUME_ROOM		0x101								//消耗房卡
#define TASK_TYPE_PLAY_INNINGS		0x102								//约战局数
...
const int PERSONAL_ROOM_GUID = 32; //约战房间唯一标识
//约战游戏通用配置
...
//视频相关
#define LEN_VIDEO_NUMBER	22											//视频ID
