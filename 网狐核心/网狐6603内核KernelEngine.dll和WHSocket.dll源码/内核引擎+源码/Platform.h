...
const TCHAR szPlazaClass[]=TEXT("WHGZXHQPGamePlaza");						//广场类名
const TCHAR szProductKey[]=TEXT("WHGZXHQPGamePlatform");					//产品主键
...
//授权信息
const TCHAR szCompilation[]=TEXT("AAACBBC5-31A8-461E-8EB5-B182B1A5E23A");
