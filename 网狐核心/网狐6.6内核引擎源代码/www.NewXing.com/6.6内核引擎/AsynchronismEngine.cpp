...
//停止线程
bool CMessageThread::ConcludeThread(DWORD dwWaitSeconds)
{
...
bool __cdecl CAsynchronismEngine::StopService()
{
	...
	//停止线程
	m_MessageThread.ConcludeThread();
...
bool __cdecl CAsynchronismEngine::InsertRequest(WORD wRequestID, void * const pBuffer, WORD wDataSize, IUnknownEx * pIUnknownEx)
{
	...
	if (m_DataQueue.InsertData(wRequestID,pBuffer,wDataSize)==false) return false;
